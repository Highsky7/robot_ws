...
class YoloPathPlanningNode:
    def __init__(self):
        rospy.init_node('yolo_path_planning_node', anonymous=True)
        rospy.loginfo("--- YOLO Path Planning Node with Pure Pursuit Control ---")
        ...
        rospy.loginfo("✅ YOLO Path Planning Node with Pure Pursuit initialized successfully.")
